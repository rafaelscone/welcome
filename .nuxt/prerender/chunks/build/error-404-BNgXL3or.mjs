import { mergeProps, withCtx, createTextVNode, toDisplayString, useSSRContext, defineComponent, ref, h, resolveComponent, computed } from 'file:///home/rafael/projects/github/welcome/node_modules/.pnpm/vue@3.5.13_typescript@5.7.2/node_modules/vue/index.mjs';
...
import { ssrRenderAttrs, ssrInterpolate, ssrRenderComponent } from 'file:///home/rafael/projects/github/welcome/node_modules/.pnpm/vue@3.5.13_typescript@5.7.2/node_modules/vue/server-renderer/index.mjs';
import 'node:http';
import 'node:https';
import 'node:zlib';
import 'node:stream';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "antialiased bg-white dark:bg-black dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-black" }, _attrs))} data-v-314130ce><div class="fixed left-0 right-0 spotlight z-10" data-v-314130ce></div><div class="max-w-520px text-center z-20" data-v-314130ce><h1 class="font-medium mb-8 sm:text-10xl text-8xl" data-v-314130ce>${ssrInterpolate(__props.statusCode)}</h1><p class="font-light leading-tight mb-16 px-8 sm:px-0 sm:text-4xl text-xl" data-v-314130ce>${ssrInterpolate(__props.description)}</p><div class="flex items-center justify-center w-full" data-v-314130ce>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.14.1592_typescript@5.7.2_vite@5.4.11/node_modules/nuxt/dist/app/components/error-404.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const error404 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-314130ce"]]);

export { error404 as default };
//# sourceMappingURL=error-404-BNgXL3or.mjs.map
